...
const routes = [
    {
        ...
        name: 'Home',
        meta: {
            title: 'Faces Agency || Home'
        },
        component: () =>
            import ('../views/main-faces-site/Home.vue')
    }, 
    {
        path: '/models',
        name: 'Models',
        meta: {
            title: 'Faces Agency || Models'
        },
        component: () =>
            import ('../views/main-faces-site/Models.vue')
    }, 
    {
        path: '/model-details/:mid',
        name: 'Models',
        meta: {
            title: 'Faces Agency || Model'
        },
        props: true,
        component: () =>
            import ('../views/main-faces-site/ModelDetails.vue')
    }, 
    {
        path: '/our-works',
        name: 'Our Works',
        meta: {
            title: 'Faces Agency || Works'
        },
        props: true,
        component: () =>
            import ('../views/main-faces-site/OurWorks.vue')
    },
    {
        path: '/demo',
        component: Demo,
